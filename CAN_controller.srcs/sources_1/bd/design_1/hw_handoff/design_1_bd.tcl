...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net can_top_0_sample_point [get_bd_ports debug_2] [get_bd_pins ATTACK_MODULE_0/sample_point] [get_bd_pins MODULE_CONTROLLER_0/sample_point] [get_bd_pins can_top_0/sample_point]
