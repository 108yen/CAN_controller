...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net can_top_0_sampled_bit [get_bd_ports debug_1] [get_bd_pins can_top_0/sampled_bit]
  connect_bd_net -net can_top_0_tx_o [get_bd_ports can_signal_out] [get_bd_pins can_top_0/tx_o]
  ...
  connect_bd_net -net initializer_0_ale_i [get_bd_pins can_top_0/ale_i] [get_bd_pins initializer_0/ale_i]
  connect_bd_net -net initializer_0_clk_o [get_bd_pins can_top_0/clk_i] [get_bd_pins initializer_0/clk_o]
  connect_bd_net -net initializer_0_cs_can_i [get_bd_pins can_top_0/cs_can_i] [get_bd_pins initializer_0/cs_can_i]
  connect_bd_net -net initializer_0_rd_i [get_bd_pins can_top_0/rd_i] [get_bd_pins initializer_0/rd_i]
  connect_bd_net -net initializer_0_rst_i [get_bd_pins can_top_0/rst_i] [get_bd_pins initializer_0/rst_i]
  connect_bd_net -net initializer_0_wr_i [get_bd_pins can_top_0/wr_i] [get_bd_pins initializer_0/wr_i]
