...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net can_top_0_sample_point [get_bd_ports debug_1] [get_bd_pins ATTACK_MODULE_0/sample_point] [get_bd_pins MODULE_CONTROLLER_0/sample_point] [get_bd_pins can_top_0/sample_point]
  connect_bd_net -net can_top_0_sample_point_q [get_bd_pins ATTACK_MODULE_0/sample_point_q] [get_bd_pins can_top_0/sample_point_q]
